...
> 3. 💡 backlog: **Beam Checkout integration** (memory `reference_beam_checkout_api.md` — จุด A "ลิงก์ชำระต่อใบสั่งงาน" คุ้มสุด เพราะ `Order` ยังไม่มี field ชำระเงินเลย) · DB-backed paper prices (Neon) · growth path `/archive` (pg_trgm + LATERAL หลัง LIMIT) เมื่อ orders โตเป็นหมื่นแถว
>
> ---
