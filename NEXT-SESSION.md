...
>
> ## ⏳ Pending (2026-07-24)
> 1. 🧪 **Smoke เบาบน prod** (คุณนุ๊ก): ① เปิด /shipped + /cancelled — รายการขึ้นปกติ + filter ปี/เดือนใช้ได้ ② restore งานจาก /cancelled 1 ครั้ง — row หายจากรายการภายใน ~1-2 วินาที + งานกลับขึ้น /board (เส้น reconcile `?ids=1` ใหม่ทำงานจริง) ③ /orders เปิดดู badge สถานะปกติ ④ /board เช้าเปิดหลาย tab — โหลดเร็วปกติ (bootstrap ผ่าน cache แล้ว)
