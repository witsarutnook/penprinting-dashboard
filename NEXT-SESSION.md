...
>
> ## ⏳ Pending (2026-07-08)
> 1. 🚀 **Messenger จังหวะ 0 (คุณนุ๊ก)**: ตาม [RUNBOOK-1c-messenger-setup.md](RUNBOOK-1c-messenger-setup.md) — เช็ค/สร้าง Meta app → env 5 ตัว + **redeploy** → webhook subscribe (**messages + messaging_postbacks เท่านั้น** ห้าม message_echoes) → เพิ่มทีมงานเป็น tester
> 2. 📱 **Messenger จังหวะ 1 smoke (dev mode)**: ตาม runbook — M5 2-account + slip 4 เคส (**ส่งสลิปไม่มี caption**) + escalation ①④ → Flex เข้ากลุ่ม LINE มีแถว "ช่องทาง" + badge /quote-leads
