...
>
> ## ⏳ Pending (2026-07-16)
> 1. 📲 **คุณนุ๊ก confirm 2 ข้อความในกลุ่ม LINE ทีมงาน** (ยิงไปแล้วระหว่าง session): 🧪 "smoke test-notify — penprinting-dashboard" + 🔥 "Post-deploy smoke FAILED — penprinting-calc ... expected 499, got 500" — เห็นครบ = acceptance ข้อสุดท้ายปิด
...
> 3. 🎨 smoke LINE ที่เหลือ (④ "สั่งเลย" + /track/สลิประหว่างโหมด) · revert gate "/" เมื่อพร้อม
> 4. 📊 optional: smoke slip-metrics `?channel=` ในเบราว์เซอร์ admin (carryover)
> 5. 🔭 follow-ups เล็ก (final review notes, ไม่เร่ง): node 20/22 drift ใน smoke workflows 2 repos (แก้ตอนแตะครั้งหน้า) · box/bag baseline เพิ่ม style auto-bottom/custom (โค้ดฝั่งนั้นมี bug history) · finishing case ใน book baseline
>
> ---
>
