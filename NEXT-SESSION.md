...
>
> ## ⏳ Pending (2026-08-05)
> 1. 🧪 **Smoke จอจริงเบาๆ (carryover 8/03 — ยังไม่ confirm)**: เปิด `/cancelled` หรือ `/shipped` ค้าง ~1 นาที — ระบบควรนิ่ง (ยืนยัน H1 reconcile-loop fix บนจอจริง; automation ทดสอบเส้นนี้ไม่ได้)
