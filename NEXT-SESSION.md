...
>
> ## ⏳ Pending (2026-07-13)
> 1. 🚀 **Deploy rich menu — คุณนุ๊กรัน `bash ../line-oa-richmenu/deploy-richmenu.sh`** (ใช้ channel access token จาก LINE Developers console; rollback commands อยู่ท้าย output) → เปิดแชต OA บนมือถือเช็คเมนู 4 โซน + แตะ "CHAT with PP BOT" → ต้องเข้าโหมด AI (postback bypass gate "/") และน้อง PP แนะนำตัว
