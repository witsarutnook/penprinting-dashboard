...
>
> ## ⏳ Pending (2026-07-21)
> 1. 📲 **Smoke บน prod (คุณนุ๊ก, หลัง deploy ~3 นาที)**: `/board` render + forward งาน 1 ใบปกติ + **double-tap forward รัวๆ → ครั้งที่สองต้องได้ toast แจ้ง ไม่ใช่การ์ดซ้ำ 2 ใบ** (พิสูจน์ H2 fix บน prod). Post-deploy smoke workflow เงียบ = 7 health checks ผ่าน (fail จะมี 🔥 เข้ากลุ่ม LINE เอง)
