...
>
> ## ⏳ Pending (2026-07-24)
> 0. 📲 **คุณนุ๊กกด db-migrate บน prod** (หลัง post-deploy smoke ของ push ล่าสุดเขียว — กัน stale deploy [[feedback_db_migrate_stale_deploy]]): applied list ต้องขึ้น `idx_ai_quote_sessions_updated` — ปิด L-quotelogs-order-by-no-index end-to-end
