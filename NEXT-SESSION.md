...
>
> ## ⏳ Pending (2026-09-05)
> 1. 🔑 **คุณนุ๊ก — Vercel env (ทำได้เลย)**: Settings → Environment Variables → ลบ `APPS_SCRIPT_URL` + `APPS_SCRIPT_TOKEN` (Production/Preview/Development) → **Redeploy** → Claude verify build เขียว + `/archive?q=2026` ยังค้นได้ (positive control ว่า runtime ไม่แตะ env นี้แล้ว)
