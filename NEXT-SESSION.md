...
>
> ## ⏳ Pending (2026-07-09)
> 1. 🔑 **คุณนุ๊กกรอก privacy policy URL ใน Meta App Settings** → Basic → Privacy Policy URL = `https://penprinting.co/privacy-policy` + ช่อง Data Deletion Instructions URL ใช้ URL เดียวกัน — จากนั้นจังหวะ 2 เหลือแค่ App Review (screencast + app icon, runbook 2.2)
