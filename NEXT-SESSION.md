...
> 1. 📝 **คุณนุ๊กเพิ่มแถว Green Read 75 | 856 | 1350 ใน Sheet master tab `database`** (tab ล็อค 🔒 ผมแก้ไม่ได้) — กัน drift ตอน `/sync-paper-prices` รอบหน้า (ตอนนี้ชีทมีถึง Art 350)
> 2. 🔄 **เครื่องคุณนุ๊ก: เปิด calc.penprinting.co → ตั้งค่าระบบ → "รีเซ็ตค่าเริ่มต้น" → บันทึก** — ล้างก้อน papers ใน localStorage (ตอนนี้ทับ default ทั้งก้อน ถ้าราคา default เปลี่ยนในอนาคตเครื่องคุณนุ๊กจะ stale เงียบๆ; รีเซ็ตแล้ว "Green Read 75" ตัว default จะโชว์แทน "Green Read 75g" ตัว custom)
