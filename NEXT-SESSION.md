...
>
> ## ⏳ Pending (2026-07-13)
> 1. 📱 **M5 2-account test (carryover — urgent, live กับลูกค้าจริงแล้ว)**: บัญชีที่ 2 เข้าโหมด AI → ต้องไม่เห็นบทสนทนา/ราคาของบัญชีแรก (ทั้ง Messenger + LINE)
> 2. 🎨 **LINE rich menu รอรูปดีไซน์จากคุณนุ๊ก** (kit `../line-oa-richmenu/` พร้อม — ทางเข้า AI ทางเดียวของ LINE) · smoke LINE ที่เหลือ (④ "สั่งเลย" + /track/สลิประหว่างโหมด) · revert gate "/" เมื่อพร้อม
