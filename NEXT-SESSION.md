...
>
> ## ⏳ Pending (2026-07-30)
> 1. 🔄 **forward+undo 1 ครั้ง (คุณนุ๊ก, จอจริงเท่านั้น)** — เส้นเดียวที่เหลือจาก batch refactor 7/23: forward การ์ดไหนก็ได้ → กด "ย้อนกลับ" ใน 9 วิ → การ์ดต้องกลับที่เดิม (ถ้าไม่กลับ/ค้าง แจ้ง Claude)
