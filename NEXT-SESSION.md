...
> 1. 👀 **เช็ค NS propagation** (~24-48 ชม.) — เปิด session บอก "เช็ค DNS" → ผม dig @8.8.8.8 NS + verify ซ้ำ (ตอนปิด session public resolver ยังเห็น NS เก่า = ปกติ, HostAtom ยัง active ถึง 14 ต.ค. ไม่มีความเสี่ยง)
> 2. 👀 **Google Search Console ยัง verified?** — คุณนุ๊กแวะดูภายในสัปดาห์นี้ (TXT ย้ายครบแล้ว ควรปกติ)
