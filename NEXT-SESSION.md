...
>
> ## ⏳ Pending (2026-08-10)
> 1. 🧪 **Smoke prod (คุณนุ๊ก)**: `/orders/new` → เลือก template เดิม → ชื่องาน + ชื่อลูกค้า + สเปคต้องขึ้นครบ, วันที่รับ = วันนี้, วันกำหนดส่งว่าง, ผู้สั่งงาน = ชื่อตัวเอง (ไม่ใช่คนที่บันทึก template)
