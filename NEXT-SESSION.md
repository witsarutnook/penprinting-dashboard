...
>
> ## ⏳ Pending (2026-07-09)
> 1. ~~🔑 กรอก privacy policy URL ใน Meta App Settings~~ ✅ **DONE (2026-07-09 same-day)** — คุณนุ๊กกรอก Privacy Policy URL + Data Deletion Instructions URL แล้ว → **จังหวะ 2 เหลือแค่ App Review `pages_messaging`** (runbook 2.2: screencast สาธิต flow + app icon; ยื่นเมื่อพร้อมเปิดลูกค้าจริง)
