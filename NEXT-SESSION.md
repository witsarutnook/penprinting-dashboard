...
> 4. 🔀 **branch ยังไม่ merge** — `claude/check-slip-issue-b74d2n` ([PR](https://github.com/witsarutnook/penprinting-dashboard/pull/26)) ยังไม่เข้า main = prod ยังใช้ copy เดิมที่ชวนลูกค้าส่งซ้ำอยู่
>
> ---
